...
class Test_base(unittest.TestCase):
    ...
    def test_load_from_json(self):
        ...
        sys.stdout = sys.__stdout__
        self.assertEqual(outvarr.getvalue(), "[Rectangle] (7) 2/8 - 10/7\n")

        outvarr = StringIO()
        sys.stdout = outvarr
        print(format(list_rectangles_output[1]))
        sys.stdout = sys.__stdout__
        self.assertEqual(outvarr.getvalue(), "[Rectangle] (8) 0/0 - 2/4\n")
        ...
        sys.stdout = sys.__stdout__
        self.assertEqual(outvarr.getvalue(), "[Square] (11) 0/0 - 5\n")

        outvarr = StringIO()
        sys.stdout = outvarr
        print(format(list_squares_output[1]))
        sys.stdout = sys.__stdout__
        self.assertEqual(outvarr.getvalue(), "[Square] (12) 9/1 - 7\n")
